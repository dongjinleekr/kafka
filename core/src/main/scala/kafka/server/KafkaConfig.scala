...
object KafkaConfig {
  ...
  val CompressionBufferSizeProp = "compression.buffer.size"
  ...
  val CompressionBufferSizeDoc = "The size of compression buffer for all data generated by the producer. The default size and valid value is up to " +
    "compression.type. (<code>none</code>, <code>zstd</code>: not available. <code>gzip</code>: positive integer (default: 8192=8kb.) " +
    "<code>lz4</code>: 4~7 (4=64kb, 5=256kb, 6=1mb, 7=4mb. default: 4.) <code>snappy</code>: positive integer (default: 32768=32kb)."
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean, dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  def compressionBufferSize = getString(KafkaConfig.CompressionBufferSizeProp)
