...
public class TopicConfig {
    ...
    public static final String COMPRESSION_BUFFER_SIZE_DOC = "The size of compression buffer for all data generated by the producer. The default size and valid value is up to "
