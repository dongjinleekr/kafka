...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(Map<String, Object> configs,
        ...
        try {
            ...
            Map<CompressionType, CompressionConfig> compressionConfigs = CompressionConfig.from(config.getString(ProducerConfig.COMPRESSION_CONFIG_CONFIG));
            this.compressionConfig = compressionConfigs.get(compressionType);
