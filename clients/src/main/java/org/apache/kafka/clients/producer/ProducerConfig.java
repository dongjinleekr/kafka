...
public class ProducerConfig extends AbstractConfig {
    ...
    /** <code>compression.buffer.size</code> */
    public static final String COMPRESSION_BUFFER_SIZE_CONFIG = "compression.buffer.size";
    private static final String COMPRESSION_BUFFER_SIZE_DOC = "The size of compression buffer for all data generated by the producer. The default size and valid value is up to "
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG, Type.LIST, Collections.emptyList(), new ConfigDef.NonNullValidator(), Importance.HIGH, CommonClientConfigs.BOOTSTRAP_SERVERS_DOC)
                                ...
                                .define(COMPRESSION_LEVEL_CONFIG, Type.STRING, "", new ConfigDef.CompressionLevelValidator(), Importance.MEDIUM, COMPRESSION_LEVEL_DOC)
                                .define(COMPRESSION_BUFFER_SIZE_CONFIG, Type.STRING, "", new ConfigDef.CompressionBufferSizeValidator(), Importance.MEDIUM, COMPRESSION_BUFFER_SIZE_DOC)
