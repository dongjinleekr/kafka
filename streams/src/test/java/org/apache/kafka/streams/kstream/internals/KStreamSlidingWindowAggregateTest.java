...
public class KStreamSlidingWindowAggregateTest {
    ...
    @Test
    public void shouldLogAndMeterWhenSkippingNullKey() throws InterruptedException {
        ...
        try (final LogCaptureContext logCaptureContext = LogCaptureContext.create();
            ...
            assertThat(logCaptureContext.getMessages(), hasItem("WARN Skipping record due to null key or value. value=[1] topic=[topic] partition=[0] offset=[0] "));
        }
    }

    @Test
    public void shouldLogAndMeterWhenSkippingExpiredWindowByGrace() throws InterruptedException {
        final String builtInMetricsVersion = StreamsConfig.METRICS_LATEST;
        final StreamsBuilder builder = new StreamsBuilder();
        final String topic = "topic";
        final WindowBytesStoreSupplier storeSupplier =
        ...
        try (final LogCaptureContext logCaptureContext = LogCaptureContext.create();
            ...
            assertThat(logCaptureContext.getMessages(), hasItems(
                    ...
                    containsString("WARN Skipping record for expired window. key=[k] topic=[topic] partition=[0] offset=[1] timestamp=[100] window=[90,100] expiration=[110] streamTime=[200]"),
                    // left window for k@101
                    containsString("WARN Skipping record for expired window. key=[k] topic=[topic] partition=[0] offset=[2] timestamp=[101] window=[91,101] expiration=[110] streamTime=[200]"),
                    // left window for k@102
                    containsString("WARN Skipping record for expired window. key=[k] topic=[topic] partition=[0] offset=[3] timestamp=[102] window=[92,102] expiration=[110] streamTime=[200]"),
                    // left window for k@103
                    containsString("WARN Skipping record for expired window. key=[k] topic=[topic] partition=[0] offset=[4] timestamp=[103] window=[93,103] expiration=[110] streamTime=[200]"),
                    // left window for k@104
                    containsString("WARN Skipping record for expired window. key=[k] topic=[topic] partition=[0] offset=[5] timestamp=[104] window=[94,104] expiration=[110] streamTime=[200]"),
                    // left window for k@105
                    containsString("WARN Skipping record for expired window. key=[k] topic=[topic] partition=[0] offset=[6] timestamp=[105] window=[95,105] expiration=[110] streamTime=[200]"),
                    // left window for k@15
                    containsString("WARN Skipping record for expired window. key=[k] topic=[topic] partition=[0] offset=[7] timestamp=[15] window=[5,15] expiration=[110] streamTime=[200]")
            ));
